...
var handleVectorMap=function() {
    ...
    0!==$("#world-map").length&&$("#world-map").vectorMap( {
        map:"world_mill_en", scaleColors:[COLOR_GREY_DARKER, COLOR_GREY_LIGHTER], normalizeFunction:"polynomial", hoverOpacity:.5, hoverColor:!1, zoomOnScroll:!1, markerStyle: {
            initial: {
                fill: COLOR_GREEN, stroke: "transparent", r: 3
            }
        }
        , regionStyle: {
            initial: {
                fill: COLOR_BLACK_LIGHTER, "fill-opacity": 1, stroke: "none", "stroke-width": .4, "stroke-opacity": 1
            }
            , hover: {
                "fill-opacity": .8
            }
        ...
        , backgroundColor:COLOR_BLACK, markers:[ {
...
handleInteractiveChart=function() {
    ...
    if(0!==$("#interactive-chart").length) {
        ...
        $.plot($("#interactive-chart"), [ {
            data:e, label:"Page Views", color:COLOR_BLUE, lines: {
                show: !0, fill: !1, lineWidth: 2
            }
            , points: {
                show: !0, radius: 3, fillColor: COLOR_WHITE
            }
            , shadowSize:0
        }
        , {
            data:i, label:"Visitors", color:COLOR_GREEN, lines: {
                show: !0, fill: !1, lineWidth: 2
            }
            , points: {
                show: !0, radius: 3, fillColor: COLOR_WHITE
            ...
            , yaxis: {
                ticks: 10, tickColor: COLOR_BLACK_TRANSPARENT_2, min: 0, max: 200
            }
            , grid: {
                hoverable: !0, clickable: !0, tickColor: COLOR_BLACK_TRANSPARENT_2, borderWidth: 1, backgroundColor: 'transparent', borderColor: COLOR_BLACK_TRANSPARENT_2
            }
            , legend: {
                labelBoxBorderColor: COLOR_BLACK_TRANSPARENT_2, margin: 10, noColumns: 1, show: !0
            }
        }
        );
        var l=null;
...
handleDashboardSparkline=function() {
    ...
    function a() {
        ...
        e.type="line",
        e.height="23px",
        e.lineColor=COLOR_RED,
        e.highlightLineColor=COLOR_RED,
        e.highlightSpotColor=COLOR_RED;
    ...
    var e= {
        height: "50px", width: "100%", fillColor: "transparent", lineWidth: 2, spotRadius: "4", highlightLineColor: COLOR_BLUE, highlightSpotColor: COLOR_BLUE, spotColor: !1, minSpotColor: !1, maxSpotColor: !1
    }
    ;
    a(),
