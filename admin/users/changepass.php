 ...
 if(isset($_REQUEST['id']))
	{
		$id = $_REQUEST['id'];
		//echo $id;
        $get_customer_details = mysqli_query($connection,"SELECT * FROM users WHERE staff_id='$id'") or die("Could not get the user details");
...
?>
        ...
        <form role="form" role="form">          
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input type="hidden" class="form-control " id="showpass" placeholder="Previous Password" value="<?php echo $row['password'];?>" / >
     ...
     <div class="modal-footer">
        ...
        <button type="button" class="btn btn-info" id="btn_pass">Submit</button>
      </div>
    </div>
...
$(document ).ready(function() {
    ...
    document.getElementById('btn_pass').addEventListener('click', changePass);
        ...
        {
            $('#btn_pass').text('');
            $('#btn_pass').append('<span> Please wait... </span>');
